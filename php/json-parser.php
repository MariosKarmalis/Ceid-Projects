...
/**
 * TODO --> Integrate with user login.
 * todo : get logged-in user id.
 * todo : get uploaded json file.
 */
...
function getDistance($lat,$lon,$p_lat = 38.230462, $p_lon = 21.753150, $earth_radius = 6371000)
{
  ...
  */
  ...
  // TODO Integrate with front-end and get uploaded file.
  $json = file_get_contents("../Demo_Data/setB.json");
  ...
  foreach ($json2['locations'] as $loc) {
    ...
    if( $dist < 10000 ){
      $sql = "INSERT INTO locations (loc_timestamp,latE7,longE7,accuracy,velocity,altitude,heading,userid) 
        VALUES ('$timestampMs','$latitudeE7','$longitudeE7','$accuracy',$velocity,$heading,$altitude,'6')";
