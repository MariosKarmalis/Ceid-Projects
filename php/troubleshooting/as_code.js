...
function toLocations(json) {
    return cast(JSON.parse(json), r("Locations"));
}

function locationsToJson(value) {
    return JSON.stringify(uncast(value, r("Locations")), null, 2);
}
...
const typeMap = {
    ...
    "Location": o([
        ...
        { json: "activity", js: "activity", typ: u(undefined, a(r("LocationActivity"))) },
        { json: "altitude", js: "altitude", typ: u(undefined, 0) },
        { json: "verticalAccuracy", js: "verticalAccuracy", typ: u(undefined, 0) },
    ], false),
    "LocationActivity": o([
        { json: "timestampMs", js: "timestampMs", typ: "" },
        { json: "activity", js: "activity", typ: a(r("ActivityActivity")) },
    ], false),
    "ActivityActivity": o([
...
module.exports = {
    "locationsToJson": locationsToJson,
